...
<div class="col-lg-6">
<span class="logo">quiZZone</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:slimenation.jinx@gmail.com" style="color:#000000">slimenation.jinx@gmail.com</a><br /><br />
...
<a href="https://github.com/Abhishek-Greninja17" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Profile.jpeg" width=100 height=100 alt="Abhishek" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://github.com/Abhishek-Greninja17" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Abhishek Prasad Das</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8968033033</h4>
		<h4 style="font-family:'typo' ">slimenation.jinx@gmail.com</h4>
		<h4 style="font-family:'typo' ">Indian Insitute of Technology(ISM), Dhanbad</h4></div></div>
		</p>
      </div>
