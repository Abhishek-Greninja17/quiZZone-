...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Q-Zone</b></a>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Profile.jpeg" width=100 height=100 alt="Abhishek Prasad Das" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Abhishek Prasad Das</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8968033033</h4>
		<h4 style="font-family:'typo' ">abhi17greninja@gmail.com</h4>
		<h4 style="font-family:'typo' ">Indian Institute of Technology, ISM</h4></div></div>
		</p>
      </div>
